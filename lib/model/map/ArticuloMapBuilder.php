...
/**
 * This class adds structure of 'articulo' table to 'propel' DatabaseMap object.
 *
 *
...
class ArticuloMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('FUENTE', 'Fuente', 'VARCHAR', false, 255);

		$tMap->addColumn('TAGS', 'Tags', 'VARCHAR', false, 255);
