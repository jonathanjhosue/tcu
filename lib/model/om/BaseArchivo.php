...
abstract class BaseArchivo extends BaseObject  implements Persistent {
  ...
  const PEER = 'ArchivoPeer';
	...
	public function setArchivo($v)
	{
		...
		if ($this->archivo !== $v) {
			$this->archivo = $v;
			$this->modifiedColumns[] = ArchivoPeer::ARCHIVO;
		}
	...
	public function setPersonaId($v)
	{
		...
		if ($this->persona_id !== $v) {
			$this->persona_id = $v;
			$this->modifiedColumns[] = ArchivoPeer::PERSONA_ID;
		}
	...
	public function setTipoId($v)
	{
		...
		if ($this->tipo_id !== $v) {
			$this->tipo_id = $v;
			$this->modifiedColumns[] = ArchivoPeer::TIPO_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->archivo = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->persona_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->tipo_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			...
			return $startcol + 8; // 8 = ArchivoPeer::NUM_COLUMNS - ArchivoPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isNew() && !$this->isColumnModified(ArchivoPeer::CREATED_AT))
    {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArchivoPeer::ARCHIVO)) $criteria->add(ArchivoPeer::ARCHIVO, $this->archivo);
		if ($this->isColumnModified(ArchivoPeer::PERSONA_ID)) $criteria->add(ArchivoPeer::PERSONA_ID, $this->persona_id);
		if ($this->isColumnModified(ArchivoPeer::TIPO_ID)) $criteria->add(ArchivoPeer::TIPO_ID, $this->tipo_id);
	...
	public function getPersona(PropelPDO $con = null)
	{
		if ($this->aPersona === null && ($this->persona_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPersona->addArchivos($this);
			 */
		}
	...
	public function getTipo(PropelPDO $con = null)
	{
		if ($this->aTipo === null && ($this->tipo_id !== null)) {
			$c = new Criteria(TipoPeer::DATABASE_NAME);
			$c->add(TipoPeer::ID, $this->tipo_id);
			$this->aTipo = TipoPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aTipo->addArchivos($this);
			 */
		}
		return $this->aTipo;
	}
