...
abstract class BaseArticulo extends BaseObject  implements Persistent {
  ...
  const PEER = 'ArticuloPeer';
	...
	/**
	 * Initializes internal state of BaseArticulo object.
	 * @see        applyDefaults()
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ArticuloPeer::ID;
		}
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = ArticuloPeer::NOMBRE;
		}
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = ArticuloPeer::DESCRIPCION;
		}
	...
	public function setTexto($v)
	{
		...
		if ($this->texto !== $v) {
			$this->texto = $v;
			$this->modifiedColumns[] = ArticuloPeer::TEXTO;
		}
	...
	public function setPersonaId($v)
	{
		...
		if ($this->persona_id !== $v) {
			$this->persona_id = $v;
			$this->modifiedColumns[] = ArticuloPeer::PERSONA_ID;
		}
	...
	public function setFuente($v)
	{
		...
		if ($this->fuente !== $v) {
			$this->fuente = $v;
			$this->modifiedColumns[] = ArticuloPeer::FUENTE;
		}
	...
	public function setTags($v)
	{
		...
		if ($this->tags !== $v) {
			$this->tags = $v;
			$this->modifiedColumns[] = ArticuloPeer::TAGS;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ArticuloPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ArticuloPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->fuente = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			...
			return $startcol + 9; // 9 = ArticuloPeer::NUM_COLUMNS - ArticuloPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    foreach (sfMixer::getCallables('BaseArticulo:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseArticulo:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseArticulo:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(ArticuloPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(ArticuloPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseArticulo:save:post') as $callable)
    {
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArticuloPeer::doInsert($this, $con);
					...
					$affectedRows += ArticuloPeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArticuloPeer::ID)) $criteria->add(ArticuloPeer::ID, $this->id);
		if ($this->isColumnModified(ArticuloPeer::NOMBRE)) $criteria->add(ArticuloPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(ArticuloPeer::DESCRIPCION)) $criteria->add(ArticuloPeer::DESCRIPCION, $this->descripcion);
		if ($this->isColumnModified(ArticuloPeer::TEXTO)) $criteria->add(ArticuloPeer::TEXTO, $this->texto);
		if ($this->isColumnModified(ArticuloPeer::PERSONA_ID)) $criteria->add(ArticuloPeer::PERSONA_ID, $this->persona_id);
		if ($this->isColumnModified(ArticuloPeer::FUENTE)) $criteria->add(ArticuloPeer::FUENTE, $this->fuente);
		if ($this->isColumnModified(ArticuloPeer::TAGS)) $criteria->add(ArticuloPeer::TAGS, $this->tags);
		if ($this->isColumnModified(ArticuloPeer::CREATED_AT)) $criteria->add(ArticuloPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(ArticuloPeer::UPDATED_AT)) $criteria->add(ArticuloPeer::UPDATED_AT, $this->updated_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArticuloPeer::ID, $this->id);
	...
	public function getPersona(PropelPDO $con = null)
	{
		if ($this->aPersona === null && ($this->persona_id !== null)) {
			$c = new Criteria(PersonaPeer::DATABASE_NAME);
			$c->add(PersonaPeer::ID, $this->persona_id);
			$this->aPersona = PersonaPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPersona->addArticulos($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseArticulo:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseArticulo::%s', $method));
    }
