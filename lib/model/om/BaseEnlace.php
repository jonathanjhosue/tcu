...
abstract class BaseEnlace extends BaseObject  implements Persistent {
  ...
  const PEER = 'EnlacePeer';
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = EnlacePeer::NOMBRE;
		}
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = EnlacePeer::DESCRIPCION;
		}
	...
	public function setWeb($v)
	{
		...
		if ($this->web !== $v) {
			$this->web = $v;
			$this->modifiedColumns[] = EnlacePeer::WEB;
		}
	...
	public function setImagen($v)
	{
		...
		if ($this->imagen !== $v) {
			$this->imagen = $v;
			$this->modifiedColumns[] = EnlacePeer::IMAGEN;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EnlacePeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = EnlacePeer::NUM_COLUMNS - EnlacePeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isModified() && !$this->isColumnModified(EnlacePeer::UPDATED_AT))
    {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EnlacePeer::NOMBRE)) $criteria->add(EnlacePeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(EnlacePeer::DESCRIPCION)) $criteria->add(EnlacePeer::DESCRIPCION, $this->descripcion);
		if ($this->isColumnModified(EnlacePeer::WEB)) $criteria->add(EnlacePeer::WEB, $this->web);
		if ($this->isColumnModified(EnlacePeer::IMAGEN)) $criteria->add(EnlacePeer::IMAGEN, $this->imagen);
		if ($this->isColumnModified(EnlacePeer::CREATED_AT)) $criteria->add(EnlacePeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(EnlacePeer::UPDATED_AT)) $criteria->add(EnlacePeer::UPDATED_AT, $this->updated_at);
